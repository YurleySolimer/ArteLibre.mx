...
router.get('/', async (req, res) => {
  ...
  if (coleccion_destacada.length > 0) {
	...
	res.render('index', {artista, nombre:nombre[0], cliente, logueado, eventos, coleccion_destacada, obras_coleccion, obra_destacada, destacadas, obra1_artista, obra2_artista,  artista_destacado});
});
