...
const { getClientsByRegion, getTotalClients, getTopClients, getTotalShoppers } = require("../services-mysql/clients");
const { getAllPrices, getAllObras, getAllObrasSold } = require("../services-mysql/obras");
